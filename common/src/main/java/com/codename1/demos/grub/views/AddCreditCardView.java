...
public class AddCreditCardView extends AbstractEntityView {
    ...
    public AddCreditCardView(Entity entity, Node viewNode) {
        ...
        Label headerLabel = new Label("EDITAR DIRECCION", "NewCreditCardHeaderLabel");
        ...
        TextField month = new TextField("", "MES", 20, TextArea.NUMERIC);
        month.setUIID("NewCardField");
        month.getHintLabel().setUIID("NewCardFieldHint");

        TextField year = new TextField("", "AÑO", 20, TextArea.NUMERIC);
        ...
        wrapper.add(BorderLayout.CENTER, BoxLayout.encloseY(
                new Label("PROPIETARIO", "AddNewCardExplanation"),
                name,
                new Label("NUMERO", "AddNewCardExplanation"),
                GridLayout.encloseIn(4, num1, num2, num3, num4),
                new Label("FECHA DE EXPIRACION", "AddNewCardExplanation"),

...
public class CompletedOrderView extends AbstractEntityView {
    ...
    public CompletedOrderView(Entity order, Node viewNode) {
        ...
        Label orderNumber = new Label("Orden #" + order.getInt(CompletedOrder.orderId), "CompletedOrderIdLabel");
        int deliverTo = order.getInt(CompletedOrder.deliveredTo);
        String deliverToText = "Home";
        if (deliverTo == Address.WORK){
            deliverToText = "Trabajo";
        ...
        Label deliverToHeaderLabel = new Label("DELIVERED para:", "CompletedOrderDeliveredToHeaderLabel");
        Label deliverToLabel = new Label(deliverToText, "CompletedOrderDeliveredToLabel");

        Label dateHeaderLabel = new Label("Fecha:", "CompletedOrderDateHeaderLabel");
        Label dateLabel = new Label(order.getText(CompletedOrder.date), "CompletedOrderDateLabel");

        Button orderAgain = new Button("Ordenar denuevo", "CompletedOrderOrderAgainButton");
        Button rate = new Button("rango", "CompletedOrderRateButton");

...
public class FilterView extends AbstractEntityView{
    ...
    public FilterView(Entity filterEntity, Node viewNode) {
        ...
        Label headerLabel = new Label("FILTRO", "FilterHeaderLabel");
        ...
        CategoryButton riceButton = new CategoryButton("ARROZ",
                "rice-icon.png",
        ...
        CategoryButton donutButton = new CategoryButton("Donas",
                "donut-icon.png",
        ...
        CategoryButton chickenButton = new CategoryButton("Pollo",
                "chicken-icon.png",
        ...
        CategoryButton steakButton = new CategoryButton("Filetes",
                "steak-icon.png",
        ...
        CategoryButton mealButton = new CategoryButton("Comida",
                "meal-icon.png",
        ...
        CategoryButton allButton = new CategoryButton("Todo",
                "all-icon.png",
        ...
        Label sortByLabel = new Label("Clasificado por", "FilterHeader");
        add(sortByLabel);
        ...
        RadioButton fastDelivery = RadioButton.createToggle(" Entrega Rapida", FontImage.createMaterial(FontImage.MATERIAL_LOCAL_SHIPPING, sortByIconStyle), bg);
        ...
        RadioButton nearYou = RadioButton.createToggle(" Cercano", FontImage.createMaterial(FontImage.MATERIAL_LOCATION_ON, sortByIconStyle), bg);
        ...
        RadioButton trending = RadioButton.createToggle(" Tendencia", FontImage.createMaterial(FontImage.MATERIAL_TRENDING_UP, sortByIconStyle), bg);
        ...
        Button applyFilterButton = new Button("APLICAR", "FilterApplyButton");

...
public class HomeView extends AbstractEntityView {
    ...
    public HomeView(Entity appEntity, Node viewNode) {
        ...
        deliverToCnt = BoxLayout.encloseY(new Button("DELIVER para", "HomeDeliverToHeaderButton"), deliverToLabel);
        ...
        Container categoryRiceButton = createCategoryButton("Arroz", "rice-icon.png", evt -> {
        ...
        Container categoryRiceButton2 = createCategoryButton("Donas", "donut-icon.png", evt -> {
        ...
        Container categoryRiceButton3 = createCategoryButton("Pollo", "chicken-icon.png", evt -> {
        ...
        Container categoryRiceButton4 = createCategoryButton("Filetes", "steak-icon.png", evt -> {
        ...
        Container categoryRiceButton5 = createCategoryButton("Comida", "meal-icon.png", evt -> {
        ...
        Container categoryRiceButton7 = createCategoryButton("Todo", "all-icon.png", evt -> {
        ...
        Label popularLabel = new Label("Popular cercano", "CategoryHeader");
        ...
        Label allRestaurantsLabel = new Label("Todos los Restaurantes", "CategoryHeader");
        ...
        Button backToTopButton = new Button("Volver", "BackToTopButton");

...
public class MainWindowOrdersView extends AbstractEntityView {
    ...
    public MainWindowOrdersView(Entity account, Node viewNode) {
        ...
        Label headerLabel = new Label("Mis Ordenes", "MyOrdersHeaderLabel");
        ...
        ordersView.addTab("Reciente", recentOrdersView);
    ...
    public void addCompletedOrder(Entity completedOrder){
        ...
        Label orderId = new Label ("Orden #" + completedOrder.getInt(CompletedOrder.orderId), "OrderIdLabel");
        deliveryInfoCnt.add(BorderLayout.NORTH, BoxLayout.encloseY(trackingOrderLabel, orderId));

        Label preparingFoodLabel = new Label ("Preparando", "PreparingFoodLabel");
        Label drivesAtTheRestaurantLabel = new Label ("Drives en el Restaurante", "DrivesAtTheRestaurantLabel");
        ...
        Label driverName = new Label("James Rodrigez", "DriverNameLabel");

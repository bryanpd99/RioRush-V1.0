...
public class NewAddressView extends AbstractEntityView {
    ...
    public NewAddressView(AddressModel address, Node viewNode) {
        ...
        Label headerLabel = new Label("Añadir direccion", "EditAddressesHeaderLabel");
        ...
        RadioButton work = RadioButton.createToggle(" Trabajo", FontImage.createMaterial(FontImage.MATERIAL_WORK, addressTypeStyle), bg);
        ...
        RadioButton other = RadioButton.createToggle(" Otros", FontImage.createMaterial(FontImage.MATERIAL_PLACE, addressTypeStyle), bg);
        ...
        Button saveAddress = new Button("Guardar", "SaveAddressConfirmButton");

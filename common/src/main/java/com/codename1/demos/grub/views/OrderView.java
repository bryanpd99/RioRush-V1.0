...
public class OrderView extends AbstractEntityView {
    ...
    public OrderView(Entity restEntity, Entity profileEntity, Node viewNode, Node mainWindowNode) {
        ...
        Label headerLabel = new Label("MIS ORDENES", "AddDishHeaderLabel");
        ...
        MultiButton addPromoCodeButton = new MultiButton("AÑADIR CODIGO DE PROMO");
        ...
        deliverToButton = new MultiButton("DELIVER PARA");
